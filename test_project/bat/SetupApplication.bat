...
:: Android packaging
set AND_CERT_NAME="NotificationTest"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\NotificationTest.p12
...
set IOS_PROVISION=cert\NotificationTest.mobileprovision
...
set APP_ID=air.com.illuzor.notificationextention.NotificationTest

:: Output packages
set DIST_PATH=dist
set DIST_NAME=NotificationTest
